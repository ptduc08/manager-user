...
class Admin_Form_ValidateProduct {
	...
	public function __construct() {
		...
		$this->_arrStyle['product_assessment'] = '';
		$this->_arrStyle['product_guarantee'] = '';
		$this->_arrStyle['product_model'] = '';
		$this->_arrStyle['product_code'] = '';
		$this->_arrStyle['product_guarantee_policy'] = '';
		$this->_arrStyle['product_price_new'] = '';
		$this->_arrStyle['view_counter'] = '';
